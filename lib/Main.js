...
module.exports = {
    ...
    activate: function(state) {
        console.log('执行 activate viewer');
    ...
    deactivate: function() {
        console.log('执行 deactivate viewer');
    ...
    serialize: function() {
        console.log('执行 serialize viewer');
    ...
    initPanel: function() {
        console.log('执行 initPanel viewer');
    ...
    togglePanel: function() {
        console.log('执行 togglePanel viewer');
    ...
    updatePanel: function(newContent) {
        console.log('执行 updatePanel viewer');
    ...
    destroyPanel: function() {
        console.log('执行 destroyPanel viewer');
    ...
    showPanel: function() {
        console.log('执行 showPanel viewer');
    ...
    disablePanel: function() {
        console.log('执行 disablePanel viewer');
    ...
    updateClassInfo: function() {
        console.log('执行 updateClassInfo viewer');
        ...
        var onSuccess = (emptyFiguresData) => {
            console.log('updateClassInfo success');
        ...
        var onError = (e) => {
            console.log('updateClassInfo error');
            //console.warn(UPDATING_FAILED_MESSAGE, e.message);
    ...
    registerEvents: function() {
        console.log('执行 registerEvents viewer');
    ...
    registerCommands: function() {
        console.log('执行 registerCommands viewer');
